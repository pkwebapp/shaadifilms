...
export const metadata: Metadata = {
  ...
  keywords: ["wedding photography Mumbai", "Indian wedding photographer", "cinematic wedding films", "Andheri West photographer", "luxury wedding services", "Shaadifilms", "best wedding photographer in Mumbai"],
  openGraph: {
